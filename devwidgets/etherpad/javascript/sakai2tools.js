...
require(["jquery", "sakai/sakai.api.core", "sakai/sakai.api.widgets"], function($, sakai, sakaiWidgetsAPI) {
     ...
     */
    sakai_global.etherpad = function(tuid, showSettings){
        ...
        var saveRemoteContent = function(){
            var  saveContentAjax = function(json_data) {
                ...
                json.ltiurl =  "http://localhost:9000/blti"  //$(basicltiSettingsLtiUrl).val() || "";    
                json[":operation"] = "basiclti";
                json["sling:resourceType"] = "sakai/basiclti";
                json.ltikey = "etherpad";  // $(basicltiSettingsLtiKey).val() || "";
                json.ltisecret = "etherpad"; //$(basicltiSettingsLtiSecret).val() || "";
    ...
    sakai.api.Widgets.widgetLoader.informOnLoad("etherpad");
});
