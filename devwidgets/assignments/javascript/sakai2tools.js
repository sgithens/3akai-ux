...
require(["jquery", "sakai/sakai.api.core", "sakai/sakai.api.widgets"], function($, sakai, sakaiWidgetsAPI) {
     ...
     */
    sakai_global.assignments = function(tuid, showSettings){
        ...
        var saveRemoteContent = function(){
            ...
            if (isSakai2Tool()) {
                json["lti_virtual_tool_id"] = "sakai.assignment.grades"; //$('#basiclti_settings_lti_virtual_tool_id').val();    
    ...
    sakai.api.Widgets.widgetLoader.informOnLoad("assignments");
});
